...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/maindir/css/eek.css">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        {{-- <img class="sch_logo" src="/storage/classified/Nursing/n0.png"> --}}
	      <a class="navbar-brand" href="/">EEK <span>CONSULTS</span> 
        <p class="sch_name">And Electricals LTD.</p></a>
        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">PivoApps</h2>
              <p>lkjhghjkl</p>
            </div>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">contact</span></a></li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="">Copyright © {{date('Y')}} PivoApps Inc. All rights reserved. <span class="float_right2">Powered by <a target="_blank" href="/https://www.pivoapps.net">PivoApps</a></span></p>
        </div>
    </div>
